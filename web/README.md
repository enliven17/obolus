...
Next.js 16 app for [obolus.xyz](https://obolus.xyz). Marketing site, API docs, and admin dashboard.
...
| -------------------------- | --------------- | ----------------------------------------------------- |
| `NEXT_PUBLIC_API_BASE_URL` | Production only | Backend API base URL, e.g. `https://api.obolus.xyz` |
