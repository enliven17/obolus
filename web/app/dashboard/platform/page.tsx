  ...
  return (
    <PageContainer>
      ...
      <KpiRow>
        ...
        <KpiTile
          label="Treasury SOL"
          value={data.treasury.sol !== null ? parseFloat(data.treasury.sol).toFixed(2) : '—'}
          hint={
      ...
      <Card title="Treasury">
        ...
        >
          ...
          <div style={{ color: 'var(--fg-dim)' }}>SOL</div>
          <div style={{ fontFamily: 'var(--font-mono)' }}>
            {data.treasury.sol !== null ? parseFloat(data.treasury.sol).toFixed(7) : '—'}
          </div>
