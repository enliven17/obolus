...
// Only uses real settlement data (ctx_invoice_sol × settlement_xlm_usd_rate).
        ...
        <Card>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 900 }}>
              <thead>
                <tr>
                  ...
                  <th style={{ ...TH, textAlign: 'right' }}>SOL Rate</th>
                  ...
                  return (
                    <tr key={o.id} style={noData ? { opacity: 0.5 } : undefined}>
                      ...
                      <td style={{ ...TD, fontSize: '0.7rem' }}>
                        {o.payment_asset?.replace('_solana', '') || '—'}
                      </td>
                      ...
                      <td style={{ ...dim, textAlign: 'right' }}>
                        {o.ctx_invoice_sol
                          ? `${parseFloat(o.ctx_invoice_sol).toFixed(4)} SOL`
                          : '—'}
                      </td>
                      <td style={{ ...dim, textAlign: 'right' }}>
          ...
          {s && s.orders_without_cost_data > 0 && (
            ...
            >
              ...
              rows). New orders automatically capture CTX invoice amounts and SOL rates at payment
              time.
            </div>
          )}
        </Card>
