...
export interface Order {
  ...
  metadata?: { service_id?: string; reason?: string; agent?: boolean } | null;
}
...
export interface User {
  ...
  email: string;
  role: string;
  // Deployment-level flag from OBOLUS_PLATFORM_ADMIN_EMAIL — controls
...
export const USDC_ISSUER = '4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU';
