// Merchants — card grid of the gift-card products obolus has
...
export default function MerchantsPage() {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Merchants"
        subtitle="Gift card products Obolus has onboarded. More are coming — contact support if you need a specific one enabled."
      />
