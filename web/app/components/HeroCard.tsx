...
// ~/code/obolusanimation/index.html with three deltas:
//   - Idle drift dialled back from ±8/±6 to ±2.5/±1.8 per pass.
//   - The brand mark is replaced with a Obolus wordmark rendered
  ...
  return (
    <>
      <div className="hc-card-wrap">
        ...
        <article ref={cardRef} className="hc-card" aria-label="Obolus virtual card">
          ...
          <div className="hc-card-content">
            <header className="hc-topline">
              <span className="hc-brand-wordmark" aria-label="Obolus">Obolus</span>
  ...
  return (
    <style>{`
      ...
      .hc-scene {
        ...
        pointer-events: none;
        background:
          radial-gradient(circle at 22% 22%, rgba(245, 175, 175, 0.12), transparent 26rem),
          radial-gradient(circle at 78% 18%, rgba(249, 223, 223, 0.15), transparent 22rem),
          radial-gradient(circle at 70% 85%, rgba(251, 239, 239, 0.1), transparent 30rem);
      }
      .hc-scene::before,
      .hc-scene::after {
        content: '';
      ...
      .hc-scene::after {
        ...
        background:
          radial-gradient(circle at 30% 30%, rgba(245, 175, 175, 0.15), transparent 55%),
          radial-gradient(circle at 72% 40%, rgba(245, 175, 175, 0.1), transparent 58%),
          radial-gradient(circle at 55% 80%, rgba(251, 239, 239, 0.1), transparent 60%),
          radial-gradient(circle at 85% 70%, rgba(251, 239, 239, 0.08), transparent 45%);
        opacity: 0.7;
      }
      ...
      .hc-halo {
        ...
        /* Softer radial stop gives the halo look without needing
           ...
           halo is static. */
        background: radial-gradient(circle, rgba(245, 175, 175, 0.2), transparent 62%);
        opacity: 0.85;
      ...
      .hc-halo::after {
        inset: 30%;
        border-color: rgba(245, 175, 175, 0.3);
      }
    ...
    <style>{`
      ...
      .hc-card-shadow {
        ...
        background: radial-gradient(
          ellipse at center,
          rgba(245, 175, 175, 0.3),
          rgba(245, 175, 175, 0.1) 48%,
          rgba(0, 0, 0, 0) 72%
        );
      ...
      .hc-card {
        ...
        background:
          linear-gradient(
            135deg,
            rgba(252, 248, 248, 0.9),
            rgba(251, 239, 239, 0.75) 35%,
            rgba(249, 223, 223, 0.85)
          ),
          linear-gradient(
            160deg,
            rgba(245, 175, 175, 0.35),
            rgba(249, 223, 223, 0.2) 42%,
            rgba(251, 239, 239, 0.3) 78%,
            rgba(245, 175, 175, 0.25)
          ),
          #FCF8F8;
        border: 1px solid rgba(245, 175, 175, 0.5);
        box-shadow:
          0 2rem 4rem rgba(245, 175, 175, 0.3),
          0 0 0 1px rgba(245, 175, 175, 0.2) inset,
          0 0 4rem rgba(245, 175, 175, 0.2);
        transform-style: preserve-3d;
      ...
      .hc-card::before {
        ...
        background:
          linear-gradient(115deg, transparent 20%, rgba(245, 175, 175, 0.12) 45%, transparent 58%),
          radial-gradient(
            circle at var(--pointer-x) var(--pointer-y),
            rgba(245, 175, 175, 0.15),
            transparent 28%
          );
      ...
      .hc-card::after {
        background:
          repeating-linear-gradient(90deg, rgba(245, 175, 175, 0.08) 0 1px, transparent 1px 34px),
          repeating-linear-gradient(0deg, rgba(245, 175, 175, 0.06) 0 1px, transparent 1px 34px);
      ...
      .hc-card-shell {
        ...
        background:
          ...
          linear-gradient(
            145deg,
            rgba(245, 175, 175, 0.4),
            rgba(249, 223, 223, 0.25) 44%,
            rgba(251, 239, 239, 0.35) 78%,
            rgba(245, 175, 175, 0.3)
          );
        opacity: 0;
      ...
      .hc-card-outline rect {
        ...
        filter:
          ...
          drop-shadow(0 0 18px rgba(245, 175, 175, 0.4));
        animation:
      ...
      /* Override uppercase for the Ruthie brand wordmark */
      .hc-topline .hc-brand-wordmark {
        text-transform: none;
      ...
      /* Obolus wordmark on the card face — Ruthie font */
      .hc-brand-wordmark {
        font-family: var(--font-ruthie, 'Ruthie', cursive);
        font-size: 1.7rem;
        line-height: 1;
        color: #7a3a3a;
        flex-shrink: 0;
      ...
      .hc-balance strong {
        ...
        color: #2D2D2D;
        text-shadow: 0 1px 4px rgba(245, 175, 175, 0.3);
