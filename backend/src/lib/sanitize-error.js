...
//
// Why: the obolus ↔ vcc ↔ CTX ↔ scraper pipeline has a lot of
...
const RULES = Object.freeze([
  ...
  // fires on genuine Solana-submit failures from the agent's wallet.
  {
