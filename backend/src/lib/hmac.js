// @ts-check
// Shared HMAC sign + verify for the vcc ↔ obolus callback channel.
//
 ...
 *
 * The nonce is a per-job UUID generated by obolus at invoice time and
 * stored on both the order (obolus) and the job (vcc). Including it in
